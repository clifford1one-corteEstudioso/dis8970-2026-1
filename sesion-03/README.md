...
![diagrama de todos los métodos de análisis del cerebro y de sus partes](./imgs/several-methods.jpg)
...
![foto de un fMRI](./imgs/fmri.jpg)

consiste en un imán que genera un fuerza no presentes en la naturaleza

![diagrama de la respuesta vascular ante el estímulo cerebral](./imgs/vascular-response.jpg)
...
![Imagen de los resultados de un fMRI](./imgs/fmri-results.png)
